        ...
        if (Platform.OS !== 'android' && Platform.OS !== 'ios') {
            return (
                <View style={{ marginBottom: 20, borderBottomWidth: 1, borderBottomColor: 'black', paddingBottom: 10 }}>
                    ...
                    <Button color='#72AF67' style={{ marginBottom: 5 }} title="Add Comment" onPress={() => { setSelectedLandmarkId(item.landmarkId); setModalVisible(true); }} />
                </View>
            );
        } else {
            ...
            return (
                <View>
                    ...
                    <View style={{ marginBottom: 5, width: '100%' }}>
                        <Button color='#72AF67' title="Add Comment" onPress={() => { setSelectedLandmarkId(item.landmarkId); setModalVisible(true); }} />
                    </View>
                </View>
            );
            ...
            <View style={{ flex: 1, flexDirection: 'column', alignItems: 'center', marginBottom: 30, marginTop: 10, padding: 5 }}>
                {Platform.OS !== 'android' && Platform.OS !== 'ios' ? (
                    <>
                        ...
                        <Button color='#72AF67' title="Refresh" onPress={() => { handleRefresh() }} />
                        </View>
